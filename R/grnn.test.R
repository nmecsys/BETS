...
#' 
#' @param results The object returned by \link[BETS]{grnn.train}. 
...
grnn.test = function(results, test.set){
...
BETS.grnn.test = function(results, test.set){
  ...
  return(res)
>>>>>>> 71754a35b050d392363ebfd3f352018aae3558c9:R/BETS.grnn.test.R
}