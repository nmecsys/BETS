...
#' \item{\code{net}: An object returned by the grnn function. Represents a trained net. }
...
#' }
#' 
#' grnn.train also returns a diagnostic of training rounds and a \code{sigma} versus \code{accuracy} plot. 
#' 
...
grnn.train = function(train.set, sigma, step = 0.1, select = TRUE, names = NA){
...
BETS.grnn.train = function(train.set, sigma, step = 0.1, select = TRUE, names = NA){
  ...
  return(results)
>>>>>>> 71754a35b050d392363ebfd3f352018aae3558c9:R/BETS.grnn.train.R
}