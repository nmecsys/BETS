...
```{asis echo = htk2}
We are led to conclude that the residuals of the second model are also heteroskedastic. It seems that the class of SARIMA models are not suited to forecasting the original series.
```
