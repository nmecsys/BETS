...
A `chart` foi inicialmente projetada para ser uma função privada, auxiliar da `dashboard`. No entanto, pensamos ser de grande valia para o usuário dispor de um meio de obter os gráficos dos *dashboard*s separadamente, de modo a poder incorporá-los em seus trabalhos. 
